...
";
	...
	<div class="col-md-5">
			...
			<tr>
				...
				<td><a href="CourseUpdt?StudentNo=<?php echo $row['StudentNo']; ?>"><input type="button" Value="Düzenle" class="btn btn-info btn-sm"></a>
				</td>
				<td><a href="SrchCourses?deleteid=<?php echo $row['StudentNo']; ?>"><input type="submit" Value="Sil" name="delete" class="btn btn-danger"></a>
				</td>
			</tr>
			<?php } ?>
			</table>
